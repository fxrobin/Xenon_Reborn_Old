...
public class GamePlayScreen implements Screen
{
	...
	public GamePlayScreen(MainControler ctrl)
	{
		...
		this.main = ctrl;
		TextureManager tMan = ctrl.getTextureManager();
		space = tMan.getSpace();
		leftbg = tMan.getLeftbg();
		rightbg = tMan.getRightbg();
		footer = tMan.getFooter();
		font = this.main.getFontManager().getFont();
	}
	...
	private void checkFire(float delta)
	{
		...
		{
			AnimatedSprite s = AnimationCatalog.FRIENDLY_SHOOT.createAnimatedSprite();
			s.setOriginCenter();
